...
def main(ijob):
    ...
    jdl_templ = f"{submitdir}/submit_step2.templ.jdl"
    sh_templ  = f"{submitdir}/submit_step2.templ.sh"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--nJobs', help='How many step1 jobs were created', type=int, default=100)
    args = parser.parse_args()
    for iJob in range(args.nJobs):
        print(f'Running step2 for job {iJob}........')
        main(iJob+1)
